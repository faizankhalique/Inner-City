...
const ScratchTheLotteryGame = require("../../../../assets/images/ScratchTheLotteryGame.png");
const Sound = require("../../../../assets/icons/Sound.png");

const ScratchTheLottery = ({ navigation }) => {
  return (
      ...
      <View style={styles.innerContainer}>
        ...
        <View style={styles.modalContainer}>
          ...
          <View style={styles.modalInnerContainer}>
            ...
            <Text style={styles.headerTitle}>Scratch The Lottery</Text>
            <Image
              resizeMode="stretch"
              source={ScratchTheLotteryGame}
              style={styles.scratchTheLotteryImage}
            />
          </View>
...
export default ScratchTheLottery;
